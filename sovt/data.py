...
class Data():
    ...
    def load(self):
        ...
        tasks = [
            ...
            # here
            [513, "Soft Ah", 1, "Baseline", 415.03, 419.88, [7], list(range(6, 14)), list(range(13, 19)), [23]],
            [513, "Soft Ah", 2, "Baseline", 422.80, 427.76, [7], list(range(6, 14)), list(range(14, 19)), [23]],
            [513, "Soft Ah", 3, "Baseline", 430.45, 435.10, [7], list(range(6, 14)), list(range(14, 19)), [23]],
            [513, "Soft Ah", 1, "Arousal", 1233.87, 1237.93, [7], list(range(6, 14)), list(range(14, 18)), [23]],
            [513, "Soft Ah", 2, "Arousal", 1240.53, 1245.16, [7], list(range(6, 14)), list(range(14, 18)), [23]],
            [513, "Soft Ah", 3, "Arousal", 1248.48, 1251.92, [7], list(range(6, 14)), list(range(14, 18)), [23]],
            [513, "Loud Ah", 1, "Baseline", 441.05, 445.89, [7], list(range(6, 14)), list(range(13, 18)), [23]],
            [513, "Loud Ah", 2, "Baseline", 448.54, 453.88, [7], list(range(6, 14)), list(range(13, 19)), [23]],
            [513, "Loud Ah", 3, "Baseline", 457.28, 460.95, [7], list(range(6, 14)), list(range(15, 18)), [23]],
            [513, "Loud Ah", 1, "Arousal", 1256.24, 1260.77, [7], list(range(6, 15)), list(range(14, 19)), [23]],
            [513, "Loud Ah", 2, "Arousal", 1264.46, 1267.72, [7], list(range(6, 15)), list(range(14, 18)), [23]],
            [513, "Loud Ah", 3, "Arousal", 1271.48, 1274.80, [7, 8], list(range(6, 15)), list(range(15, 19)), [23]],
            [513, "Straw Phonation", 1, "Baseline", 516.11, 520.97, [7, 8], list(range(6, 14)), list(range(15, 19)), [23]],
            [513, "Straw Phonation", 2, "Baseline", 524.38, 530.35, [7, 8], list(range(6, 14)), list(range(16, 20)), [23]],
            [513, "Straw Phonation", 3, "Baseline", 534.59, 540.67, [7, 8], list(range(6, 14)), list(range(16, 20)), [23]],
            [513, "Straw Phonation", 1, "Arousal", 1293.73, 1298.15, [7, 8], list(range(6, 15)), list(range(15, 19)), [23]],
            [513, "Straw Phonation", 2, "Arousal", 1302.01, 1307.27, [7, 8], list(range(6, 14)), list(range(16, 19)), [23]],
            [513, "Straw Phonation", 3, "Arousal", 1311.01, 1316.04, [7, 8], list(range(6, 15)), list(range(16, 20)), [23]],
            [513, "Straw Blowing", 1, "Baseline", 546.97, 552.96,  [7, 8], list(range(7, 16)), list(range(16, 19)), [23]],
            [513, "Straw Blowing", 2, "Baseline", 575.86, 579.81, [7, 8], list(range(7, 15)), list(range(15, 19)), [23]],
            [513, "Straw Blowing", 3, "Baseline", 584.65, 590.85, [7, 8], list(range(7, 15)), list(range(16, 20)), [23]],
            [513, "Straw Blowing", 1, "Arousal", 1319.84, 1325.07, [7, 8], list(range(7, 15)), list(range(16, 20)), [23]],
            [513, "Straw Blowing", 2, "Arousal", 1328.61, 1334.75, [7, 8], list(range(6, 15)), list(range(16, 20)), [23]],
            [513, "Straw Blowing", 3, "Arousal", 1338.58, 1343.90, [7, 8], list(range(6, 15)), list(range(15, 20)), [23]],
            [513, "Bilabial Fricative", 1, "Baseline", 835.34, 838.96, [7, 8, 9], list(range(6, 14)), list(range(16, 19)), [23]],
            [513, "Bilabial Fricative", 2, "Baseline", 842.78, 848.09, [7, 8], list(range(7, 16)), list(range(16, 19)), [23]],
            [513, "Bilabial Fricative", 3, "Baseline", 851.20, 856.87, [7, 8], list(range(7, 16)), list(range(16, 19)), [23]],
            [513, "Bilabial Fricative", 4, "Baseline", 859.70, 864.31, [7, 8], list(range(6, 16)), list(range(16, 19)), [23]],
            [513, "Bilabial Fricative", 1, "Arousal", 1352.79, 1357.48, [7, 8], list(range(6, 15)), list(range(16, 19)), [23]],
            [513, "Bilabial Fricative", 2, "Arousal", 1361.16, 1366.48, [7, 8], list(range(6, 15)), list(range(16, 20)), [23]],
            [513, "Bilabial Fricative", 3, "Arousal", 1369.13, 1374.89, [7, 8], list(range(6, 15)), list(range(16, 20)), [23]],
            [513, "Bilabial Fricative", 4, "Arousal", 1377.89, 1382.74, [7, 8, 9], list(range(6, 15)), list(range(16, 20)), [23]],
            [513, "Raspberry", 1, "Baseline", 816.26, 821.35, [7, 8, 9], list(range(6, 14)), list(range(15, 19)), [23]],
            [513, "Raspberry", 2, "Baseline", 825.58, 828.38, [7, 8, 9], list(range(6, 14)), list(range(16, 20)), [23]],
            [513, "Raspberry", 1, "Arousal", 1502.71, 1505.32, [7, 8, 9], list(range(6, 15)), list(range(15, 19)), [23]],
            [513, "Raspberry", 2, "Arousal", 1508.30, 1511.09, [7, 8], list(range(6, 15)), list(range(15, 19)), [23]],
            [513, "Raspberry", 3, "Arousal", 1514.49, 1517.05, [7, 8], list(range(6, 15)), list(range(16, 19)), [23]],
            [513, "Lip Trill", 1, "Baseline", 668.67, 671.54, [7, 8], list(range(6, 14)), list(range(16, 20)), [23]],
            [513, "Lip Trill", 2, "Baseline", 676.56, 679.05, [7, 8], list(range(6, 14)), list(range(16, 20)), [23]],
            [513, "Lip Trill", 3, "Baseline", 683.92, 686.80, [7, 8], list(range(6, 14)), list(range(16, 20)), [23]],
            [513, "Lip Trill", 1, "Arousal", 1393.29, 1396.41, [7, 8], list(range(6, 14)), list(range(16, 20)), [23]],
            [513, "Lip Trill", 2, "Arousal", 1401.15, 1404.55, [7], list(range(6, 14)), list(range(16, 20)), [23]],
            [513, "Lip Trill", 3, "Arousal", 1409.42, 1412.90, [7, 8], list(range(6, 14)), list(range(16, 19)), [23]],
            [513, "Lip Trill", 4, "Arousal", 1417.64, 1420.41, [7, 8], list(range(6, 14)), list(range(16, 19)), [23]],
            [513, "M", 1, "Baseline", 870.88, 876.13, [6], list(range(5, 13)), list(range(15, 18)), [23]],
            [513, "M", 2, "Baseline", 880.43, 884.15, [6], list(range(5, 13)), list(range(15, 18)), [23]],
            [513, "M", 1, "Arousal", 1521.52, 1526.49, [6], list(range(5, 13)), list(range(14, 18)), [23]],
            [513, "M", 2, "Arousal", 1528.97, 1533.85, [6], list(range(5, 13)), list(range(14, 18)), [23]],
            [513, "M", 3, "Arousal", 1535.72, 1540.34, [6], list(range(5, 13)), list(range(14, 18)), [23]],
            [513, "N", 1, "Baseline", 887.87, 892.67, [6], list(range(5, 13)), list(range(14, 18)), [23]],
            [513, "N", 2, "Baseline", 896.29, 901.17, [6], list(range(5, 13)), list(range(14, 18)), [23]],
            [513, "N", 1, "Arousal", 1542.73, 1546.94, [6], list(range(5, 13)), list(range(13, 18)), [23]],
            [513, "N", 2, "Arousal", 1548.54, 1552.21, [6], list(range(5, 13)), list(range(13, 18)), [23]],
            [513, "N", 3, "Arousal", 1555.22, 1559.17, [6], list(range(5, 13)), list(range(13, 18)), [23]]]
