...
class Data():
    ...
    def load(self):
        ...
        tasks = [
            ...
            [521, "Resting Nasal Breathing 5 Cycles", 1, "Baseline", 341.94, 375.81, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 17)), [26]],
            [521, "Resting Oral Breathing 5 Cycles", 1, "Baseline", 396.57, 428.13, [5, 6, 7, 8], list(range(9, 12)), list(range(12, 17)), [26]],
            [521, "Comfortable Ah", 1, "Baseline", 494.81, 499.35, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Comfortable Ah", 2, "Baseline", 504.30, 509.46, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 19)), [26]],
            [521, "Comfortable Ah", 3, "Baseline", 517.76, 520.09, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Comfortable Ah", 1, "Arousal", 1217.34, 1221.48, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Comfortable Ah", 2, "Arousal", 1224.73, 1228.70, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 19)), [26]],
            [521, "Comfortable Ah", 3, "Arousal", 1232.00, 1236.34, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 19)), [26]],
            [521, "Soft Ah", 1, "Baseline", 554.86, 559.46, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 19)), [26]],
            [521, "Soft Ah", 2, "Baseline", 563.44, 568.41, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 19)), [26]],
            [521, "Soft Ah", 3, "Baseline", 572.42, 577.61, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 19)), [26]],
            [521, "Soft Ah", 1, "Arousal", 1261.29, 1266.27, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Soft Ah", 2, "Arousal", 1267.85, 1272.25, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Soft Ah", 3, "Arousal", 1274.48, 1279.01, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Loud Ah", 1, "Baseline", 524.66, 530.01, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 19)), [26]],
            [521, "Loud Ah", 2, "Baseline", 534.88, 540.51, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 19)), [26]],
            [521, "Loud Ah", 3, "Baseline", 544.86, 550.10, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 19)), [26]],
            [521, "Loud Ah", 1, "Arousal", 1239.87, 1244.05, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 19)), [26]],
            [521, "Loud Ah", 2, "Arousal", 1247.30, 1251.45, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 19)), [26]],
            [521, "Loud Ah", 3, "Arousal", 1254.53, 1258.29, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 19)), [26]],
            [521, "Straw Phonation", 1, "Baseline", 617.97, 622.48, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Straw Phonation", 2, "Baseline", 626.56, 630.86, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Straw Phonation", 3, "Baseline", 634.79, 639.27, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Straw Phonation", 1, "Arousal", 1310.08, 1314.48, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 19)), [26]],
            [521, "Straw Phonation", 2, "Arousal", 1317.29, 1322.63, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Straw Phonation", 3, "Arousal", 1324.85, 1329.58, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Straw Blowing", 1, "Baseline", 588.71, 592.36, [4, 5, 6, 7, 8], list(range(9, 16)), list(range(16, 19)), [26]],
            [521, "Straw Blowing", 2, "Baseline", 597.98, 603.19, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 19)), [26]],
            [521, "Straw Blowing", 3, "Baseline", 606.88, 611.87, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Straw Blowing", 1, "Arousal", 1287.71, 1291.96, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Straw Blowing", 2, "Arousal", 1295.10, 1299.24, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Straw Blowing", 3, "Arousal", 1302.47, 1306.83, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Bilabial Fricative", 1, "Baseline", 732.02, 736.70, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Bilabial Fricative", 2, "Baseline", 744.16, 748.22, [4, 5, 6, 7, 8], list(range(9, 16)), list(range(16, 18)), [26]],
            [521, "Bilabial Fricative", 3, "Baseline", 751.65, 755.74, [4, 5, 6, 7, 8], list(range(9, 16)), list(range(16, 18)), [26]],
            [521, "Bilabial Fricative", 4, "Baseline", 758.33, 762.76, [4, 5, 6, 7, 8], list(range(9, 16)), list(range(16, 18)), [26]],
            [521, "Bilabial Fricative", 1, "Arousal", 1410.48, 1415.05, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Bilabial Fricative", 2, "Arousal", 1417.69, 1422.15, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 19)), [26]],
            [521, "Bilabial Fricative", 3, "Arousal", 1424.68, 1428.87, [4, 5, 6, 7, 8], list(range(9, 15)), list(range(15, 19)), [26]],
            [521, "Raspberry", 1, "Baseline", 702.01, 705.70, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Raspberry", 2, "Baseline", 709.22, 712.79, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Raspberry", 3, "Baseline", 716.95, 720.58, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Raspberry", 1, "Arousal", 1386.66, 1389.89, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Raspberry", 2, "Arousal", 1393.70, 1396.73, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Raspberry", 3, "Arousal", 1399.82, 1403.68, [5, 6, 7, 8], list(range(9, 15)), list(range(15, 18)), [26]],
            [521, "Lip Trill", 1, "Baseline", 666.10, 668.84, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Lip Trill", 2, "Baseline", 673.31, 677.40, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Lip Trill", 3, "Baseline", 680.29, 684.42, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Lip Trill", 4, "Baseline", 688.44, 692.80, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Lip Trill", 1, "Arousal", 1353.45, 1358.04, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Lip Trill", 2, "Arousal", 1361.52, 1366.00, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Lip Trill", 3, "Arousal", 1368.76, 1373.50, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "Lip Trill", 4, "Arousal", 1376.98, 1381.46, [5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "M", 1, "Baseline", 765.66, 769.74, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 18)), [26]],
            [521, "M", 2, "Baseline", 771.90, 776.11, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 18)), [26]],
            [521, "M", 3, "Baseline", 778.79, 782.36, [4, 5, 6, 7, 8], list(range(9, 14)), list(range(14, 18)), [26]],
            [521, "M", 1, "Arousal", 1431.94, 1436.30, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 18)), [26]],
            [521, "M", 2, "Arousal", 1439.09, 1445.21, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 18)), [26]],
            [521, "M", 3, "Arousal", 1446.91, 1452.17, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 18)), [26]],
            [521, "N", 1, "Baseline", 841.98, 845.86, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 17)), [26]],
            [521, "N", 2, "Baseline", 848.87, 852.67, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 17)), [26]],
            [521, "N", 3, "Baseline", 855.55, 858.99, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 17)), [26]],
            [521, "N", 1, "Arousal", 1453.95, 1457.72, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 17)), [26]],
            [521, "N", 2, "Arousal", 1460.73, 1464.20, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 18)), [26]],
            [521, "N", 3, "Arousal", 1467.24, 1470.72, [4, 5, 6, 7, 8], list(range(9, 13)), list(range(13, 18)), [26]],
            ...
            [513, "Resting Nasal Breathing 5 Cycles", 1, "Baseline", 351.81, 371.16, [10, 11, 12], list(range(13, 18)), list(range(18, 21)), [27]],
            [513, "Resting Nasal Breathing 5 Cycles", 1, "Arousal", 937.51, 953.36, [9, 10], list(range(11, 17)), list(range(17, 21)), [27]],
            [513, "Resting Oral Breathing 5 Cycles", 1, "Baseline", 378.41, 393.47, [10, 11, 12], list(range(13, 19)), list(range(19, 23)), [27]],
            [513, "Resting Oral Breathing 5 Cycles", 1, "Arousal", 378.56, 393.39, [10, 11, 12], list(range(13, 19)), list(range(19, 23)), [27]],
            [513, "Comfortable Ah", 1, "Baseline", 405.78, 411.53, [10, 11, 12], list(range(13, 17)), list(range(17, 22)), [27]],
            [513, "Comfortable Ah", 2, "Baseline", 415.72, 421.75, [10, 11, 12], list(range(13, 17)), list(range(17, 22)), [27]],
            [513, "Comfortable Ah", 3, "Baseline", 425.32, 431.15, [10, 11, 12], list(range(13, 17)), list(range(17, 22)), [27]],
            [513, "Comfortable Ah", 1, "Arousal", 985.73, 990.75, [10, 11, 12], list(range(13, 17)), list(range(17, 22)), [27]],
            [513, "Comfortable Ah", 2, "Arousal", 992.74, 997.27, [10, 11, 12], list(range(13, 17)), list(range(17, 22)), [27]],
            [513, "Comfortable Ah", 3, "Arousal", 999.61, 1003.82, [10, 11, 12], list(range(13, 17)), list(range(17, 22)), [27]],
            [513, "Soft Ah", 1, "Baseline", 437.38, 443.61, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "Soft Ah", 2, "Baseline", 446.90, 452.13, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "Soft Ah", 3, "Baseline", 455.45, 461.20, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "Soft Ah", 1, "Arousal", 1005.87, 1010.42, [10], list(range(11, 17)), list(range(17, 22)), [27]],
            [513, "Soft Ah", 2, "Arousal", 1012.08, 1016.85, [10], list(range(11, 17)), list(range(17, 22)), [27]],
            [513, "Soft Ah", 3, "Arousal", 1018.69, 1023.18, [10], list(range(11, 17)), list(range(17, 22)), [27]],
            [513, "Loud Ah", 1, "Baseline", 465.13, 471.93, [10], list(range(11, 17)), list(range(17, 22)), [27]],
            [513, "Loud Ah", 2, "Baseline", 474.83, 481.27, [10], list(range(11, 17)), list(range(17, 22)), [27]],
            [513, "Loud Ah", 3, "Baseline", 484.07, 490.41, [10], list(range(11, 17)), list(range(17, 22)), [27]],
            [513, "Loud Ah", 1, "Arousal", 1024.62, 1029.35, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "Loud Ah", 2, "Arousal", 1030.55, 1034.67, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "Loud Ah", 3, "Arousal", 1036.69, 1040.82, [10], list(range(11, 17)), list(range(17, 22)), [27]],
            [513, "Straw Phonation", 1, "Baseline", 558.32, 564.15, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 23)), [27]],
            [513, "Straw Phonation", 2, "Baseline", 567.00, 572.92, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 23)), [27]],
            [513, "Straw Phonation", 3, "Baseline", 575.34, 582.02, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 23)), [27]],
            [513, "Straw Phonation", 1, "Arousal", 1083.52, 1088.21, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 23)), [27]],
            [513, "Straw Phonation", 2, "Arousal", 1090.47, 1095.79, [10, 11, 12, 13], list(range(14, 21)), list(range(21, 24)), [27]],
            [513, "Straw Phonation", 3, "Arousal", 1097.51, 1102.80, [10, 11, 12, 13], list(range(14, 21)), list(range(21, 24)), [27]],
            [513, "Straw Blowing", 1, "Baseline", 523.04, 527.83,  [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Straw Blowing", 2, "Baseline", 530.41, 535.25, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Straw Blowing", 3, "Baseline", 537.86, 542.62, [10, 11, 12, 13], list(range(14, 21)), list(range(21, 24)), [27]],
            [513, "Straw Blowing", 1, "Arousal", 1060.30, 1065.76, [10, 11, 12], list(range(13, 21)), list(range(21, 24)), [27]],
            [513, "Straw Blowing", 2, "Arousal", 1067.57, 1072.98, [10, 11, 12, 13], list(range(14, 21)), list(range(21, 24)), [27]],
            [513, "Straw Blowing", 3, "Arousal", 1075.49, 1080.29, [10, 11, 12, 13], list(range(14, 21)), list(range(21, 24)), [27]],
            [513, "Bilabial Fricative", 1, "Baseline", 588.87, 594.99, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Bilabial Fricative", 2, "Baseline", 597.85, 603.17, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Bilabial Fricative", 3, "Baseline", 606.53, 612.20, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Bilabial Fricative", 1, "Arousal", 1108.54, 1113.04, [10, 11, 12], list(range(13, 21)), list(range(21, 24)), [27]],
            [513, "Bilabial Fricative", 2, "Arousal", 1114.73, 1119.98, [10, 11, 12], list(range(13, 21)), list(range(21, 24)), [27]],
            [513, "Bilabial Fricative", 3, "Arousal", 1121.70, 1126.95, [10, 11, 12, 13], list(range(14, 21)), list(range(21, 24)), [27]],
            [513, "Raspberry", 1, "Baseline", 651.84, 656.40, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Raspberry", 2, "Baseline", 658.11, 663.11, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Raspberry", 3, "Baseline", 665.03, 670.27, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Raspberry", 1, "Arousal", 1150.76, 1155.17, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Raspberry", 2, "Arousal", 1157.46, 1162.05, [10, 11, 12], list(range(13, 20)), list(range(20, 24)), [27]],
            [513, "Raspberry", 3, "Arousal", 1164.18, 1168.69, [10, 11, 12], list(range(13, 20)), list(range(20, 24)), [27]],
            [513, "Lip Trill", 1, "Baseline", 620.62, 625.39, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Lip Trill", 2, "Baseline", 627.59, 633.26, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Lip Trill", 3, "Baseline", 635.73, 640.99, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Lip Trill", 1, "Arousal", 1129.68, 1135.04, [10, 11, 12, 13], list(range(14, 20)), list(range(20, 24)), [27]],
            [513, "Lip Trill", 2, "Arousal", 1137.07, 1141.63, [10, 11, 12], list(range(13, 21)), list(range(21, 24)), [27]],
            [513, "Lip Trill", 3, "Arousal", 1143.37, 1148.02, [10, 11, 12], list(range(13, 20)), list(range(20, 24)), [27]],
            [513, "M", 1, "Baseline", 673.46, 678.65, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "M", 2, "Baseline", 679.99, 685.15, [10], list(range(11, 19)), list(range(19, 22)), [27]],
            [513, "M", 3, "Baseline", 686.51, 691.42, [10], list(range(11, 19)), list(range(19, 22)), [27]],
            [513, "M", 1, "Arousal", 1172.92, 1178.45, [10], list(range(11, 19)), list(range(19, 23)), [27]],
            [513, "M", 2, "Arousal", 1180.33, 1186.03, [10], list(range(11, 19)), list(range(19, 22)), [27]],
            [513, "M", 3, "Arousal", 1187.71, 1192.71, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "N", 1, "Baseline", 692.74, 696.55, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "N", 2, "Baseline", 699.28, 703.60, [9, 10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "N", 1, "Arousal", 1196.72, 1201.27, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "N", 2, "Arousal", 1202.68, 1207.48, [10], list(range(11, 18)), list(range(18, 22)), [27]],
            [513, "N", 3, "Arousal", 1209.17, 1213.87, [10], list(range(11, 18)), list(range(18, 22)), [27]]]
